...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <th class="cellrowborder" valign="top" width="16.62%" id="mcps1.2.5.1.2"><p id="p60204776195545"><a name="p60204776195545"></a><a name="p60204776195545"></a>是否为必选</p>
    </th>
    ...
    <td class="cellrowborder" valign="top" width="50.95%" headers="mcps1.2.5.1.4 "><p id="p34560287195545"><a name="p34560287195545"></a><a name="p34560287195545"></a>项目编号，用于资源隔离。请参考<a href="获取项目编码.md">获取项目编码</a>。</p>
    </td>
    </tr>
