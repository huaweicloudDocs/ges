...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <td class="cellrowborder" valign="top" width="62.629999999999995%" headers="mcps1.2.5.1.4 "><p id="p15631376185720"><a name="p15631376185720"></a><a name="p15631376185720"></a>项目编号，用于资源隔离。</p>
    </td>
    </tr>
