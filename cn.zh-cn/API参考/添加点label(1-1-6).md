...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <th class="cellrowborder" valign="top" width="19.139999999999997%" id="mcps1.2.5.1.2"><p id="p38998823202917"><a name="p38998823202917"></a><a name="p38998823202917"></a>是否为必选</p>
    </th>
