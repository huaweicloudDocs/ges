...
-   [功能介绍](#section17163171894318)
-   [URI](#section216321819432)
-   [请求](#section1318041824314)
-   [响应](#section15305161811439)
-   [返回值](#section9321181834310)
...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <tbody><tr id="row548917412061"><td class="cellrowborder" valign="top" width="14.420000000000002%" headers="mcps1.2.5.1.1 "><p id="p3858745120620"><a name="p3858745120620"></a><a name="p3858745120620"></a>projectId</p>
    </td>
