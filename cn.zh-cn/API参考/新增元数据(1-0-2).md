...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <td class="cellrowborder" valign="top" width="49.68%" headers="mcps1.2.5.1.4 "><p id="p2827152720620"><a name="p2827152720620"></a><a name="p2827152720620"></a>项目编号，用于资源隔离。请参考<a href="获取项目编码.md">获取项目编码</a>。</p>
    </td>
    </tr>
