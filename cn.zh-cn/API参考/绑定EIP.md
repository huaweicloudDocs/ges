...
-   URI 格式
    ...
    ```
    POST  /v1.0/{projectId}/graphs/{graphId}/action?action_id=bindEip
    ```
...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <tr id="row241714502094"><td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.1 "><p id="p692101131012"><a name="p692101131012"></a><a name="p692101131012"></a>graphId</p>
    </td>
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.2 "><p id="p49251513105"><a name="p49251513105"></a><a name="p49251513105"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.3 "><p id="p1692510120105"><a name="p1692510120105"></a><a name="p1692510120105"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="p192820110107"><a name="p192820110107"></a><a name="p192820110107"></a>图ID。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   请求样例
    ...
    ```
    POST http://Endpoint/v1.0/{projectId}/graphs{graphId}/action?action_id=bindEip
    {
...
-   参数说明
    ...
    **表 2**  Body参数说明
    ...
    <tbody><tr id="row3482949194650"><td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.1 "><p id="p30523487194723"><a name="p30523487194723"></a><a name="p30523487194723"></a>eipId</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="34.589999999999996%" headers="mcps1.2.5.1.4 "><p id="p12565678194723"><a name="p12565678194723"></a><a name="p12565678194723"></a>弹性公网IP的ID。</p>
    </td>
    </tr>
    </tbody>
    </table>
