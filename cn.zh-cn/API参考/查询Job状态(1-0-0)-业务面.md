# 查询Job状态\(1.0.0\)-业务面<a name="ges_03_0037"></a>
...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <tbody><tr id="row5069365220149"><td class="cellrowborder" valign="top" width="16.35%" headers="mcps1.2.5.1.1 "><p id="p34819880201436"><a name="p34819880201436"></a><a name="p34819880201436"></a>project_id</p>
    </td>
    ...
    <tr id="row309032620149"><td class="cellrowborder" valign="top" width="16.35%" headers="mcps1.2.5.1.1 "><p id="p27840876201436"><a name="p27840876201436"></a><a name="p27840876201436"></a>job_id</p>
    </td>
