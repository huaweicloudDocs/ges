...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="p44694427191228"><a name="p44694427191228"></a><a name="p44694427191228"></a>服务所在域ID。</p>
    </td>
    </tr>
...
-   请求样例
    ...
    ```
    GET http://Endpoint/ges/v1.0/{projectId}/graphs/{graphName}/summary
    ```
