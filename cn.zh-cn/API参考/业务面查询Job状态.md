...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <td class="cellrowborder" valign="top" width="47.17%" headers="mcps1.2.5.1.4 "><p id="p46986778201436"><a name="p46986778201436"></a><a name="p46986778201436"></a>服务所在域ID。</p>
    </td>
    </tr>
...
-   参数说明
    ...
    **表 3**  data参数说明
    ...
    <td class="cellrowborder" valign="top" width="11.05%" headers="mcps1.2.5.1.2 "><p id="p2489539120184"><a name="p2489539120184"></a><a name="p2489539120184"></a>否</p>
    </td>
