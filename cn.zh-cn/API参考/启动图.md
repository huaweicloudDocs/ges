...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <td class="cellrowborder" valign="top" width="36.84%" headers="mcps1.2.5.1.4 "><p id="p4121436617943"><a name="p4121436617943"></a><a name="p4121436617943"></a>服务所在域ID。</p>
    </td>
    </tr>
...
-   参数说明
    ...
    **表 2**  Body参数说明
    ...
    <td class="cellrowborder" valign="top" width="56.43564356435643%" headers="mcps1.2.5.1.4 "><p id="p17256596165833"><a name="p17256596165833"></a><a name="p17256596165833"></a>启动图时关联的备份ID，设置此参数时，表示从备份进行启动；如果为空，表示从上次关闭图时的状态启动。</p>
    </td>
    </tr>
    </tbody>
    </table>
