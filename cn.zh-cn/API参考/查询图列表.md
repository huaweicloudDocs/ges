...
-   URI格式
    ...
    ```
    GET https://Endpoint/v1.0/{projectId}/graphs?offset={offset}&limit={limit}
    ```
...
<td class="cellrowborder" valign="top" width="10.99%" headers="mcps1.2.5.1.2 "><p id="p34739636"><a name="p34739636"></a><a name="p34739636"></a>是</p>
</td>
...
<td class="cellrowborder" valign="top" width="10.99%" headers="mcps1.2.5.1.2 "><p id="p38848593"><a name="p38848593"></a><a name="p38848593"></a>是</p>
</td>
...
<td class="cellrowborder" valign="top" width="10.9%" headers="mcps1.2.5.1.3 "><p id="p24038881"><a name="p24038881"></a><a name="p24038881"></a>Integer</p>
</td>
...
<a name="ul13270826"></a><a name="ul13270826"></a><ul id="ul13270826"><li>100：创建或启动中</li><li>200：运行中</li><li>201：升级中</li><li>202：导入中</li><li>203：回滚中</li><li>204：导出中</li><li>300：故障</li><li>303：创建失败</li><li>400：被删除</li><li>900：停止</li><li>901：停止中</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="62.77%" headers="mcps1.2.5.1.4 "><p id="p37563373"><a name="p37563373"></a><a name="p37563373"></a>图创建时间。只有图状态为200时该字段的值不为空。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="62.77%" headers="mcps1.2.5.1.4 "><p id="p25448063"><a name="p25448063"></a><a name="p25448063"></a>图更新时间。只有图状态为200时该字段的值不为空。</p>
</td>
</tr>
...
<a name="ul12281171272313"></a><a name="ul12281171272313"></a><ul id="ul12281171272313"><li>success：完全导入成功</li><li>partFailed：部分失败</li><li>failed：完全导入失败</li></ul>
</td>
</tr>
</tbody>
</table>
