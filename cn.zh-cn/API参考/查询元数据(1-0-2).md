...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <th class="cellrowborder" valign="top" width="15.989999999999998%" id="mcps1.2.5.1.2"><p id="p52062036195942"><a name="p52062036195942"></a><a name="p52062036195942"></a>是否为必选</p>
    </th>
    ...
    <td class="cellrowborder" valign="top" width="46.19%" headers="mcps1.2.5.1.4 "><p id="p64770585195942"><a name="p64770585195942"></a><a name="p64770585195942"></a>项目编号，用于资源隔离。请参考<a href="获取项目编码.md">获取项目编码</a>。</p>
    </td>
    </tr>
