...
<th class="cellrowborder" valign="top" width="6.17%" id="mcps1.2.5.1.2"><p id="p1678314017335"><a name="p1678314017335"></a><a name="p1678314017335"></a>版本</p>
</th>
<th class="cellrowborder" valign="top" width="43.07%" id="mcps1.2.5.1.3"><p id="p2857142143413"><a name="p2857142143413"></a><a name="p2857142143413"></a>URL</p>
</th>
...
<td class="cellrowborder" valign="top" width="6.17%" headers="mcps1.2.5.1.2 "><p id="p147834015334"><a name="p147834015334"></a><a name="p147834015334"></a><a href="查询图列表(1-0-0).md">1.0.0</a></p>
</td>
<td class="cellrowborder" valign="top" width="43.07%" headers="mcps1.2.5.1.3 "><p id="p139041836161116"><a name="p139041836161116"></a><a name="p139041836161116"></a>GET /v1.0/{projectId}/graphs?offset=<em id="i13904133601115"><a name="i13904133601115"></a><a name="i13904133601115"></a>{offset}</em>&amp;limit=<em id="i10904103661110"><a name="i10904103661110"></a><a name="i10904103661110"></a>{limit}</em></p>
</td>
...
<td class="cellrowborder" valign="top" width="6.17%" headers="mcps1.2.5.1.2 "><p id="p15783130173313"><a name="p15783130173313"></a><a name="p15783130173313"></a><a href="查询图详情(1-0-0).md">1.0.0</a></p>
</td>
<td class="cellrowborder" valign="top" width="43.07%" headers="mcps1.2.5.1.3 "><p id="p1961915192120"><a name="p1961915192120"></a><a name="p1961915192120"></a>GET /v1.0/{projectId}/graphs/{graphId}</p>
</td>
...
<tr id="row2571642143417"><td class="cellrowborder" valign="top" width="11.06%" headers="mcps1.2.5.1.1 "><p id="p145721142163415"><a name="p145721142163415"></a><a name="p145721142163415"></a>创建图</p>
</td>
<td class="cellrowborder" valign="top" width="6.17%" headers="mcps1.2.5.1.2 "><p id="p12784110143314"><a name="p12784110143314"></a><a name="p12784110143314"></a><a href="创建图（1-0-0）.md">1.0.0</a></p>
</td>
<td class="cellrowborder" valign="top" width="43.07%" headers="mcps1.2.5.1.3 "><p id="p2573184614129"><a name="p2573184614129"></a><a name="p2573184614129"></a>POST /v1.0/{projectId}/graphs</p>
</td>
<td class="cellrowborder" valign="top" width="39.7%" headers="mcps1.2.5.1.4 "><p id="p64472013105513"><a name="p64472013105513"></a><a name="p64472013105513"></a>用户定义好图的元数据和点、边数据集后，下一步就是创建一个图。</p>
</td>
</tr>
<tr id="row121041449970"><td class="cellrowborder" valign="top" width="11.06%" headers="mcps1.2.5.1.1 "><p id="p1488195114814"><a name="p1488195114814"></a><a name="p1488195114814"></a>创建图</p>
</td>
<td class="cellrowborder" valign="top" width="6.17%" headers="mcps1.2.5.1.2 "><p id="p888165115815"><a name="p888165115815"></a><a name="p888165115815"></a><a href="创建图(2-1-2).md">2.1.2</a></p>
</td>
<td class="cellrowborder" valign="top" width="43.07%" headers="mcps1.2.5.1.3 "><p id="p58813511287"><a name="p58813511287"></a><a name="p58813511287"></a>POST /v1.0/{projectId}/graphs</p>
</td>
<td class="cellrowborder" valign="top" width="39.7%" headers="mcps1.2.5.1.4 "><p id="p10881051086"><a name="p10881051086"></a><a name="p10881051086"></a>用户定义好图的元数据和点、边数据集后，下一步就是创建一个图。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="6.17%" headers="mcps1.2.5.1.2 "><p id="p20871856181"><a name="p20871856181"></a><a name="p20871856181"></a><a href="创建图(2-1-5).md">2.1.5</a></p>
</td>
<td class="cellrowborder" valign="top" width="43.07%" headers="mcps1.2.5.1.3 "><p id="p38716561284"><a name="p38716561284"></a><a name="p38716561284"></a>POST /v1.0/{projectId}/graphs</p>
</td>
...
<td class="cellrowborder" valign="top" width="6.17%" headers="mcps1.2.5.1.2 "><p id="p1278417083320"><a name="p1278417083320"></a><a name="p1278417083320"></a><a href="关闭图(1-0-0).md">1.0.0</a></p>
</td>
<td class="cellrowborder" valign="top" width="43.07%" headers="mcps1.2.5.1.3 "><p id="p41101158181210"><a name="p41101158181210"></a><a name="p41101158181210"></a>POST/v1.0/{projectId}/graphs/{graphId}/action?action_id=stop</p>
</td>
...
<td class="cellrowborder" valign="top" width="6.17%" headers="mcps1.2.5.1.2 "><p id="p47841000339"><a name="p47841000339"></a><a name="p47841000339"></a><a href="启动图(1-0-0).md">1.0.0</a></p>
</td>
<td class="cellrowborder" valign="top" width="43.07%" headers="mcps1.2.5.1.3 "><p id="p39535239138"><a name="p39535239138"></a><a name="p39535239138"></a>POST /v1.0/{projectId}/graphs/{graphId}/action?action_id=start</p>
</td>
...
<td class="cellrowborder" valign="top" width="6.17%" headers="mcps1.2.5.1.2 "><p id="p147845053318"><a name="p147845053318"></a><a name="p147845053318"></a><a href="删除图(1-0-0).md">1.0.0</a></p>
</td>
<td class="cellrowborder" valign="top" width="43.07%" headers="mcps1.2.5.1.3 "><p id="p7914841191312"><a name="p7914841191312"></a><a name="p7914841191312"></a>DELETE /v1.0/{projectId}/graphs/{graphId}</p>
</td>
...
<td class="cellrowborder" valign="top" width="6.17%" headers="mcps1.2.5.1.2 "><p id="p16784708331"><a name="p16784708331"></a><a name="p16784708331"></a><a href="增量导入图(1-0-5).md">1.0.5</a></p>
</td>
<td class="cellrowborder" valign="top" width="43.07%" headers="mcps1.2.5.1.3 "><p id="p75231857191313"><a name="p75231857191313"></a><a name="p75231857191313"></a>POST  /v1.0/{projectId}/graphs/{graphId}/action?action_id=import-graph</p>
</td>
...
<td class="cellrowborder" valign="top" width="6.17%" headers="mcps1.2.5.1.2 "><p id="p87845073317"><a name="p87845073317"></a><a name="p87845073317"></a><a href="导出图(1-0-5).md">1.0.5</a></p>
</td>
<td class="cellrowborder" valign="top" width="43.07%" headers="mcps1.2.5.1.3 "><p id="p41821936121410"><a name="p41821936121410"></a><a name="p41821936121410"></a>POST /v1.0/{projectId}/graphs/{graphId}/action?action_id=export-graph</p>
</td>
...
<td class="cellrowborder" valign="top" width="6.17%" headers="mcps1.2.5.1.2 "><p id="p3784160153312"><a name="p3784160153312"></a><a name="p3784160153312"></a><a href="清空图(1-1-6).md">1.1.6</a></p>
</td>
<td class="cellrowborder" valign="top" width="43.07%" headers="mcps1.2.5.1.3 "><p id="p43421051510"><a name="p43421051510"></a><a name="p43421051510"></a>POST /v1.0/{projectId}/graphs/{graphId}/action?action_id=clear-graph</p>
</td>
...
<td class="cellrowborder" valign="top" width="6.17%" headers="mcps1.2.5.1.2 "><p id="p107841700334"><a name="p107841700334"></a><a name="p107841700334"></a><a href="升级图(1-0-5).md">1.0.5</a></p>
</td>
<td class="cellrowborder" valign="top" width="43.07%" headers="mcps1.2.5.1.3 "><p id="p168801769156"><a name="p168801769156"></a><a name="p168801769156"></a>POST  /v1.0/{projectId}/graphs/{graphId}/action?action_id=upgrade</p>
</td>
...
<td class="cellrowborder" valign="top" width="6.17%" headers="mcps1.2.5.1.2 "><p id="p07841906333"><a name="p07841906333"></a><a name="p07841906333"></a><a href="绑定EIP(1-0-6).md">1.0.6</a></p>
</td>
<td class="cellrowborder" valign="top" width="43.07%" headers="mcps1.2.5.1.3 "><p id="p12141315131511"><a name="p12141315131511"></a><a name="p12141315131511"></a>POST  /v1.0/{projectId}/graphs/{graphId}/action?action_id=bindEip</p>
</td>
...
<td class="cellrowborder" valign="top" width="6.17%" headers="mcps1.2.5.1.2 "><p id="p12785110103317"><a name="p12785110103317"></a><a name="p12785110103317"></a><a href="解绑EIP(1-0-6).md">1.0.6</a></p>
</td>
<td class="cellrowborder" valign="top" width="43.07%" headers="mcps1.2.5.1.3 "><p id="p9433102216151"><a name="p9433102216151"></a><a name="p9433102216151"></a>POST  /v1.0/{projectId}/graphs/{graphId}/action?action_id=unbindEip</p>
</td>
...
<th class="cellrowborder" valign="top" width="5.59055905590559%" id="mcps1.2.5.1.2"><p id="p13527133913501"><a name="p13527133913501"></a><a name="p13527133913501"></a>版本</p>
</th>
<th class="cellrowborder" valign="top" width="42.724272427242724%" id="mcps1.2.5.1.3"><p id="p519022815382"><a name="p519022815382"></a><a name="p519022815382"></a>URL</p>
</th>
...
<td class="cellrowborder" valign="top" width="5.59055905590559%" headers="mcps1.2.5.1.2 "><p id="p1752813915019"><a name="p1752813915019"></a><a name="p1752813915019"></a><a href="查询元数据列表(1-0-2).md">1.0.2</a></p>
</td>
<td class="cellrowborder" valign="top" width="42.724272427242724%" headers="mcps1.2.5.1.3 "><p id="p5513191110367"><a name="p5513191110367"></a><a name="p5513191110367"></a>GET /v1.0/{projectId}/graphs/metadatas?offset=<em id="i14513411133611"><a name="i14513411133611"></a><a name="i14513411133611"></a>{offset}</em>&amp;limit=<em id="i1451391133617"><a name="i1451391133617"></a><a name="i1451391133617"></a>{limit}</em></p>
</td>
...
<td class="cellrowborder" valign="top" width="5.59055905590559%" headers="mcps1.2.5.1.2 "><p id="p0528163955012"><a name="p0528163955012"></a><a name="p0528163955012"></a><a href="查询元数据(1-0-2).md">1.0.2</a></p>
</td>
<td class="cellrowborder" valign="top" width="42.724272427242724%" headers="mcps1.2.5.1.3 "><p id="p7672200181719"><a name="p7672200181719"></a><a name="p7672200181719"></a>GET/v1.0/{projectId}/graphs/metadatas/{metadataId}</p>
</td>
...
<td class="cellrowborder" valign="top" width="5.59055905590559%" headers="mcps1.2.5.1.2 "><p id="p195281439115012"><a name="p195281439115012"></a><a name="p195281439115012"></a><a href="新增元数据(1-0-2).md">1.0.2</a></p>
</td>
<td class="cellrowborder" valign="top" width="42.724272427242724%" headers="mcps1.2.5.1.3 "><p id="p12222147191719"><a name="p12222147191719"></a><a name="p12222147191719"></a>POST /v1.0/{projectId}/graphs/metadatas</p>
</td>
...
<td class="cellrowborder" valign="top" width="5.59055905590559%" headers="mcps1.2.5.1.2 "><p id="p105286397501"><a name="p105286397501"></a><a name="p105286397501"></a><a href="删除元数据(1-0-2).md">1.0.2</a></p>
</td>
<td class="cellrowborder" valign="top" width="42.724272427242724%" headers="mcps1.2.5.1.3 "><p id="p1769741441719"><a name="p1769741441719"></a><a name="p1769741441719"></a>DELETE/v1.0/{projectId}/graphs/metadatas/{metadataId}</p>
</td>
