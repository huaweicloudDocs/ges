...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <th class="cellrowborder" valign="top" width="19.77%" id="mcps1.2.5.1.2"><p id="p48314489194842"><a name="p48314489194842"></a><a name="p48314489194842"></a>是否为必选</p>
    </th>
    ...
    <td class="cellrowborder" valign="top" width="43.3%" headers="mcps1.2.5.1.4 "><p id="p35533134194842"><a name="p35533134194842"></a><a name="p35533134194842"></a>项目编号，用于资源隔离。请参考<a href="获取项目编码-2.md">获取项目编码</a>。</p>
    </td>
    </tr>
