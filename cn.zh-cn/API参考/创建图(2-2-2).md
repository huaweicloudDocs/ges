...
-   请求样例
    ...
    POST https://Endpoint/v1.0/{projectId}/graphs
    {
    	...
    	"dataSource": {
            ...
            "enableMultiAz":false,
            "sys_tags": [{"key": "_sys_enterprise_project_id", 
...
<td class="cellrowborder" valign="top" width="31.44%" headers="mcps1.2.5.1.3 "><p id="p28574727"><a name="p28574727"></a><a name="p28574727"></a>参考<a href="#table58050486">表3 graph图类型数据结构说明</a>。</p>
</td>
...
<td class="cellrowborder" valign="top" width="47.410000000000004%" headers="mcps1.2.5.1.4 "><p id="p52503305"><a name="p52503305"></a><a name="p52503305"></a>图名称（输入长度在4位到64位之间，必须以字母开头，可以包含字母、数字或者下划线，不能包含其他的特殊字符）。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="47.410000000000004%" headers="mcps1.2.5.1.4 "><p id="p733123412491"><a name="p733123412491"></a><a name="p733123412491"></a>图实例是否加密，默认不加密。具体请参考<a href="#table1595055345117">表9</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="47.410000000000004%" headers="mcps1.2.5.1.4 "><p id="p1759315632713"><a name="p1759315632713"></a><a name="p1759315632713"></a>企业项目信息，如果未指定则不开启，默认不开启。具体请参考<a href="#table1088843022917">表10</a></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="54.410000000000004%" headers="mcps1.2.5.1.4 "><p id="p27291358142819"><a name="p27291358142819"></a><a name="p27291358142819"></a>数据源参数。具体请参考<a href="#table1144993664716">表7</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="56.330000000000005%" headers="mcps1.2.5.1.4 "><p id="p124551936104715"><a name="p124551936104715"></a><a name="p124551936104715"></a>重复边处理。具体请参考<a href="#table7375123175015">表8</a>。</p>
</td>
</tr>
</tbody>
</table>
