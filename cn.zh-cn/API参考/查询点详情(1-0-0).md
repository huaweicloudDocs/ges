...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <td class="cellrowborder" valign="top" width="57.220000000000006%" headers="mcps1.2.5.1.4 "><p id="p30378991181042"><a name="p30378991181042"></a><a name="p30378991181042"></a>项目编号，用于资源隔离。</p>
    </td>
    </tr>
