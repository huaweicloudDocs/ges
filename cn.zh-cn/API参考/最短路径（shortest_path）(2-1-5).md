# 最短路径（shortest\_path）\(2.1.5\)<a name="ges_03_0143"></a>
...
<a name="ul27814585182326"></a><a name="ul27814585182326"></a><ul id="ul27814585182326"><li>空：边上的权重、距离默认为<span class="parmname" id="parmname64281841182434"><a name="parmname64281841182434"></a><a name="parmname64281841182434"></a>“1”</span>。</li><li>字符串：对应的边上的属性将作为权重，当某边没有对应属性时，权重将默认为1。<div class="note" id="note1763697295448"><a name="note1763697295448"></a><a name="note1763697295448"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p1620101892212"><a name="p1620101892212"></a><a name="p1620101892212"></a>边上权重应大于0。</p>
</div></div>
<p id="p22422045615"><a name="p22422045615"></a><a name="p22422045615"></a>图规格为千亿规格（公测版）的图，暂不支持该参数。</p>
</li></ul>
</td>
...
<td class="cellrowborder" valign="top" width="10.702970297029703%" headers="mcps1.2.7.1.4 "><p id="p4969649161820"><a name="p4969649161820"></a><a name="p4969649161820"></a>Boolean</p>
</td>
...
<p id="p14844111122320"><a name="p14844111122320"></a><a name="p14844111122320"></a>图规格为千亿规格（公测版）的图，暂不支持该参数，当前仅支持true。</p>
</td>
