# 批量添加点\(2.1.16\)<a name="ges_03_0163"></a>
...
-   参数说明
    ...
    **表 2**  Body参数说明
    ...
    <th class="cellrowborder" valign="top" width="12.4%" id="mcps1.2.5.1.2"><p id="p4264326420116"><a name="p4264326420116"></a><a name="p4264326420116"></a>是否必选</p>
    </th>
    <th class="cellrowborder" valign="top" width="12.479999999999999%" id="mcps1.2.5.1.3"><p id="p3155239920116"><a name="p3155239920116"></a><a name="p3155239920116"></a>类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="58.95%" id="mcps1.2.5.1.4"><p id="p560755920116"><a name="p560755920116"></a><a name="p560755920116"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="12.4%" headers="mcps1.2.5.1.2 "><p id="p197345455816"><a name="p197345455816"></a><a name="p197345455816"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="12.479999999999999%" headers="mcps1.2.5.1.3 "><p id="p8717162515920"><a name="p8717162515920"></a><a name="p8717162515920"></a>Json</p>
    </td>
    <td class="cellrowborder" valign="top" width="58.95%" headers="mcps1.2.5.1.4 "><p id="p1814283410916"><a name="p1814283410916"></a><a name="p1814283410916"></a>待添加的顶点数组。建议一次最多添加1万个点。</p>
    </td>
    </tr>
    <tr id="row13160181912542"><td class="cellrowborder" valign="top" width="16.17%" headers="mcps1.2.5.1.1 "><p id="p916091905412"><a name="p916091905412"></a><a name="p916091905412"></a>overrideExists</p>
    </td>
    <td class="cellrowborder" valign="top" width="12.4%" headers="mcps1.2.5.1.2 "><p id="p14161121915415"><a name="p14161121915415"></a><a name="p14161121915415"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="12.479999999999999%" headers="mcps1.2.5.1.3 "><p id="p18161519195415"><a name="p18161519195415"></a><a name="p18161519195415"></a>Boolean</p>
    </td>
    <td class="cellrowborder" valign="top" width="58.95%" headers="mcps1.2.5.1.4 "><p id="p20604125512436"><a name="p20604125512436"></a><a name="p20604125512436"></a>对vertices参数中已经存在的点是否采取覆盖写策略。默认值为<span class="parmvalue" id="parmvalue560412553435"><a name="parmvalue560412553435"></a><a name="parmvalue560412553435"></a>“false”</span>，<span id="ph13532175611466"><a name="ph13532175611466"></a><a name="ph13532175611466"></a>会</span>忽略已经存在的点，不做处理。</p>
    <p id="p22422045615"><a name="p22422045615"></a><a name="p22422045615"></a>（但是图规格为千亿规格（公测版）的图，当点存在时，会报错）。</p>
    <p id="p01616193547"><a name="p01616193547"></a><a name="p01616193547"></a>当值为<span class="parmvalue" id="parmvalue1940994735617"><a name="parmvalue1940994735617"></a><a name="parmvalue1940994735617"></a>“true”</span>时，表示对vertices参数中已经存在的点采取覆盖写策略。</p>
    </td>
    </tr>
    </tbody>
    </table>
