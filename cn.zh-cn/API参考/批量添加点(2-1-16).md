...
-   参数说明
    ...
    **表 2**  Body参数说明
    ...
    <td class="cellrowborder" valign="top" width="22.189999999999998%" headers="mcps1.2.5.1.3 "><p id="p18161519195415"><a name="p18161519195415"></a><a name="p18161519195415"></a>Boolean</p>
    </td>
    <td class="cellrowborder" valign="top" width="43.76%" headers="mcps1.2.5.1.4 "><p id="p01616193547"><a name="p01616193547"></a><a name="p01616193547"></a>对vertices参数中已经存在的点是否采取覆盖写策略。默认值为<span class="parmvalue" id="parmvalue131912810561"><a name="parmvalue131912810561"></a><a name="parmvalue131912810561"></a>“false”</span>（不影响原功能和语义），当值为<span class="parmvalue" id="parmvalue1940994735617"><a name="parmvalue1940994735617"></a><a name="parmvalue1940994735617"></a>“true”</span>时，表示对vertices参数中已经存在的点采取覆盖写策略。</p>
    </td>
    </tr>
    </tbody>
    </table>
