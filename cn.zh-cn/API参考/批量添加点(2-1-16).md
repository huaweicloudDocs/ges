...
-   请求样例
    ...
    ```
    POST
    http://{SERVER_URL}/ges/v1.0/{projectId}/graphs/{graphName}/vertices/action?action_id=batch-add
    {
        "vertices": [
            {
                "vertex": "150",
...
-   参数说明
    ...
    **表 2**  Body参数说明
    ...
    <th class="cellrowborder" valign="top" width="14.67%" id="mcps1.2.5.1.3"><p id="p3155239920116"><a name="p3155239920116"></a><a name="p3155239920116"></a>类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="51.28%" id="mcps1.2.5.1.4"><p id="p560755920116"><a name="p560755920116"></a><a name="p560755920116"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="14.67%" headers="mcps1.2.5.1.3 "><p id="p8717162515920"><a name="p8717162515920"></a><a name="p8717162515920"></a>JSON</p>
    </td>
    <td class="cellrowborder" valign="top" width="51.28%" headers="mcps1.2.5.1.4 "><p id="p1814283410916"><a name="p1814283410916"></a><a name="p1814283410916"></a>待添加的顶点数组。建议一次最多添加1万个点。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="17.88%" headers="mcps1.2.5.1.2 "><p id="p14161121915415"><a name="p14161121915415"></a><a name="p14161121915415"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="14.67%" headers="mcps1.2.5.1.3 "><p id="p18161519195415"><a name="p18161519195415"></a><a name="p18161519195415"></a>Boolean</p>
    </td>
    <td class="cellrowborder" valign="top" width="51.28%" headers="mcps1.2.5.1.4 "><p id="p01616193547"><a name="p01616193547"></a><a name="p01616193547"></a>对vertices参数中已经存在的点是否采取覆盖写策略。默认值为<span class="parmvalue" id="parmvalue131912810561"><a name="parmvalue131912810561"></a><a name="parmvalue131912810561"></a>“false”</span>，忽略已经存在的点，不做处理。当值为<span class="parmvalue" id="parmvalue1940994735617"><a name="parmvalue1940994735617"></a><a name="parmvalue1940994735617"></a>“true”</span>时，表示对vertices参数中已经存在的点采取覆盖写策略。</p>
    </td>
    </tr>
    </tbody>
    </table>
