...
-   [功能介绍](#section61815836172543)
-   [URI](#section33697373172543)
-   [请求](#section60285423172543)
-   [响应](#section29815052172543)
-   [返回值](#section24845238172543)
...
-   参数说明
    ...
    **表 4**  vertexFilters参数结构
    ...
    <td class="cellrowborder" valign="top" width="64.91%" headers="mcps1.2.5.1.4 "><p id="p685618596445"><a name="p685618596445"></a><a name="p685618596445"></a>逻辑关系，可选值“=”、“&lt;”、“&gt;”、“&lt;=”、“&gt;=”、“range”、“has”“hasNot”、“full_text_match”、“full_text_prefix”、“full_text_wildcard”、“full_text_regexp”和“full_text_fuzzy”。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="64.91%" headers="mcps1.2.5.1.4 "><p id="p1885775954418"><a name="p1885775954418"></a><a name="p1885775954418"></a>属性的值。</p>
    </td>
    </tr>
