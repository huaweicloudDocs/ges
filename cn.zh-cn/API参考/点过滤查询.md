...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <td class="cellrowborder" valign="top" width="25.019999999999996%" headers="mcps1.2.5.1.4 "><p id="p60696182172640"><a name="p60696182172640"></a><a name="p60696182172640"></a>服务所在域ID</p>
    </td>
    </tr>
