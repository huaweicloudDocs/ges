...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <th class="cellrowborder" valign="top" width="15.9%" id="mcps1.2.5.1.2"><p id="p64627282172640"><a name="p64627282172640"></a><a name="p64627282172640"></a>是否为必选</p>
    </th>
    ...
    <td class="cellrowborder" valign="top" width="51.300000000000004%" headers="mcps1.2.5.1.4 "><p id="p60696182172640"><a name="p60696182172640"></a><a name="p60696182172640"></a>项目编号，用于资源隔离。请参考<a href="获取项目编码-2.md">获取项目编码</a>。</p>
    </td>
    </tr>
...
<th class="cellrowborder" valign="top" width="20.580000000000002%" id="mcps1.2.5.1.2"><p id="p16798407175214"><a name="p16798407175214"></a><a name="p16798407175214"></a>是否为必选</p>
</th>
