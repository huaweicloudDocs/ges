...
-   [算法请求](#section48190415192136)
-   [返回结果](#section185601546105013)
...
-   Body参数说明
    ...
    **表 3**  2.2.4版本新增Body参数说明
    ...
    <td class="cellrowborder" valign="top" width="54.81%" headers="mcps1.2.5.1.4 "><p id="p8964141615143"><a name="p8964141615143"></a><a name="p8964141615143"></a>路径中对节点的过滤条件。该参数仅适用于带一般过滤条件最短路径（Filtered Shortest Path）。具体格式请见 Filtered-query API中的<a href="Filtered-query-API.md#table1138175053111">表6 property_filter元素格式</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="54.81%" headers="mcps1.2.5.1.4 "><p id="p67511528181411"><a name="p67511528181411"></a><a name="p67511528181411"></a>路径中对边（关系）的过滤条件。该参数仅适用于带一般过滤条件最短路径（Filtered Shortest Path）。具体格式请见 Filtered-query API中的<a href="Filtered-query-API.md#table1138175053111">表6 property_filter元素格式</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="54.81%" headers="mcps1.2.5.1.4 "><p id="p9698241104016"><a name="p9698241104016"></a><a name="p9698241104016"></a>过滤条件列表，数组的每个元素分别对应每一层要做的查询和</p>
    <p id="p869814144017"><a name="p869814144017"></a><a name="p869814144017"></a>过滤条件。该参数仅适用于带一般过滤条件环路检测（filtered circle detection）,具体格式请见<a href="zh-cn_topic_0295360648.md#table1729539161413">filters元素格式</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
