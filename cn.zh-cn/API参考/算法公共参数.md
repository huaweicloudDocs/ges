...
-   Body参数说明
    ...
    **表 2**  2.1.7版本新增Body参数说明
    ...
    <a name="ul957414564416"></a><a name="ul957414564416"></a><ul id="ul957414564416"><li>k_hop</li><li>shortest_path</li><li>all_shortest_paths</li><li>shortest_path_of_vertex_sets</li><li>n_paths</li><li>realtime_recommandation</li></ul>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="14.82%" headers="mcps1.2.5.1.3 "><p id="p11574457444"><a name="p11574457444"></a><a name="p11574457444"></a>Int</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="14.82%" headers="mcps1.2.5.1.3 "><p id="p1757575164419"><a name="p1757575164419"></a><a name="p1757575164419"></a>Int</p>
    </td>
