...
-   参数说明
    ...
    **表 1**  URI参数说明
    ...
    <th class="cellrowborder" valign="top" width="17.25%" id="mcps1.2.5.1.2"><p id="p10855427185720"><a name="p10855427185720"></a><a name="p10855427185720"></a>是否为必选</p>
    </th>
    ...
    <td class="cellrowborder" valign="top" width="48.43%" headers="mcps1.2.5.1.4 "><p id="p15631376185720"><a name="p15631376185720"></a><a name="p15631376185720"></a>项目编号，用于资源隔离。请参考<a href="获取项目编码-2.md">获取项目编码</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="17.52%" headers="mcps1.2.5.1.3 "><p id="p47035223185720"><a name="p47035223185720"></a><a name="p47035223185720"></a>Int</p>
    </td>
